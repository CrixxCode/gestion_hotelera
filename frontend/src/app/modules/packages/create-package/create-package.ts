...
export class CreatePackage {
  ...
  submit(): void {
    ...
    if (!this.hotelSettingsId) {
      this.errorMessage = 'No se encontro una configuracion de hotel activa para crear paquetes.';
      return;
    }
  ...
  private extractErrorMessage(error: unknown): string {
    const fallback = 'No se pudo crear el paquete. Revisa los datos e intenta nuevamente.';
